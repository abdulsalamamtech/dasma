...
<div class="container">
    ...
    <div class="relative mt-10 mb-12 w-full py-5 sm:mb-6 sm:py-16 md:mt-16 md:mb-12 lg:mb-28">
        <div class="relative z-20 h-80 bg-cover bg-left bg-no-repeat sm:h-100 md:h-108 lg:h-120 lg:w-6/11 xl:w-3/5"
            style="background-image:url({{ $new_arrivals?->first()?->banner?->url ?? '/assets/img/unlicensed/coupon-image.jpg' }})">
        </div>
        <div class="right-0 bottom-0 ml-auto h-auto bg-cover bg-right bg-no-repeat sm:h-100 md:h-108 lg:absolute lg:h-120 lg:w-6/11 xl:w-3/5"
