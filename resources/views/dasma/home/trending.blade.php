    ...
    <div class="grid grid-cols-1 gap-10 pb-20 md:pb-24 lg:grid-cols-2 lg:pb-32">
        ...
        @forelse ($trends as $trend)
            <div class="relative h-56 bg-cover bg-left bg-no-repeat sm:h-80 sm:bg-center lg:h-68"
                style="background-image:url({{ $trend->banner->url ?? '/assets/img/unlicensed/collection-03.jpg'}})">
                <div class="absolute inset-0 w-2/3 px-6 py-14 md:px-10">
                    ...
                    <a href="{{ route('stores.list') . '?category=' . $trend?->category?->slug }}" class="group flex items-center pt-5">
                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-white p-2">
                            <i
                                class="bx bx-chevron-right text-xl text-primary transition-colors group-hover:text-v-red"></i>
                        </div>
                        <p
        ...
        @empty
            <div class="relative h-56 bg-cover bg-left bg-no-repeat sm:h-80 sm:bg-center lg:h-68"
                ...
                <div class="absolute inset-0 w-2/3 px-6 py-14 md:px-10">
                    ...
                    <a href="{{ route('stores.list') }}" class="group flex items-center pt-5">
                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-white p-2">
                            <i
                                class="bx bx-chevron-right text-xl text-primary transition-colors group-hover:text-v-red"></i>
                        </div>
                            ...
                            <div class="sm:px-5 lg:px-4">
                                <div class="relative flex items-center justify-center rounded"
                                    ...
                                    <div class="absolute top-0 right-0 m-4 rounded-full bg-white px-5 py-1">
                                        <p
                                            class="{{ $product->tagDesign() }} font-hk font-bold text-sm uppercase tracking-wide">
                                            {{ $product->tag ?? 'TREND' }}
                                        </p>
                                    </div>
                                    <div
                                        ...
                                        <div id="productRemoveAndAddToCart">
                                            ...
                                            @if ($product?->cartItem())
                                                {{-- Remove from cart --}}
                                                <div data-cart-id="{{ $product?->cartItem()?->id }}"
