            ...
            <div class="container">
                <div class="z-10 w-full rounded bg-white shadow-sm sm:w-1/2 lg:w-1/4">
                    <form action="{{ route('search') }}"
                        ...
                        <button class="flex items-center focus:border-transparent focus:outline-none" type="submit">
                            ...
                            <div>
                                ...
                                <div class="flex flex-col pl-3">
                                    ...
                                    <a href="{{ route('account.orders.items.index') }}"
                                        class="transition-all hover:font-bold hover:text-primary px-4 py-3 border-l-2 border-primary-lighter hover:border-primary  font-hk text-grey-darkest ">Order
                                        Items</a>
                                ...
                                @else
                                  ...
                                  <div class="flex justify-center gap-4">
                                      <a href="{{ route('login') }}"
                                          class="mt-8 inline-block rounded border border-primary px-8 py-3 font-hk font-bold hover:bg-white transition-all bg-primary text-white hover:text-primary">Log
                                          In</a>
