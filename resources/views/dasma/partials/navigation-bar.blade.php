...
<nav class="fixed top-0 left-0 w-full z-50 text-center shadow-md bg-white">
                ...
                <div class="flex items-center">
                    <a href="{{ route('account.carts.index') }}"
                        ...
                        <div id="totalCartItems"
                            class="absolute ml-3  bottom-3 md:bottom-8 z-10 text-primary border border-primary rounded-full p-1">
                            {{ request()?->user()?->carts?->count() ?? '0' }}</div>
    ...
    <div class="pointer-events-none fixed inset-x-0 z-50 pt-20 opacity-0 transition-all md:top-28"
        ...
        <div class="absolute left-0 top-0 z-40 w-full bg-white px-6 shadow-sm sm:w-1/2">
            ...
            <div class="my-8">
                <a href="{{ route('login') }}" class="btn btn-primary mb-4 w-full" aria-label="Login button">Login
                    Account</a>
                <a href="{{ route('register') }}"
                    class="block pl-3 text-center font-hk text-secondary underline md:text-lg">Create Account</a>
            </div>
        </div>
    </div>
