            ...
            <div class="bg-grey-light py-8 px-5 md:px-8">
                ...
                <div
                    ...
                    <div class="w-full text-center sm:w-3/10 sm:text-right md:w-1/4 xl:w-1/5">
                        <div class="pt-3 sm:pt-0">
                            ...
                            <span
                                class="bg-primary-lightest border border-primary-light px-4 py-3 inline-block rounded font-hk text-primary">In
                                Progress</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full text-center sm:w-3/10 sm:text-right md:w-1/4 xl:w-1/5">
                        <div class="pt-3 sm:pt-0">
                            ...
                            <span
                                class="bg-v-green-light border border-v-green px-4 py-3 inline-block rounded font-hk text-v-green">Order
                                received</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full text-center sm:w-3/10 sm:text-right md:w-1/4 xl:w-1/5">
                        <div class="pt-3 sm:pt-0">
                            ...
                            <span
                                class="bg-v-blue-light border border-v-blue px-4 py-3 inline-block rounded font-hk text-v-blue">On
                                the way</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full text-center sm:w-3/10 sm:text-right md:w-1/4 xl:w-1/5">
                        <div class="pt-3 sm:pt-0">
                            ...
                            <span
                                class="bg-v-pink border border-v-red px-4 py-3 inline-block rounded font-hk text-v-red">Delivery
                                Failed</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full text-center sm:w-3/10 sm:text-right md:w-1/4 xl:w-1/5">
                        <div class="pt-3 sm:pt-0">
                            ...
                            <span
                                class="bg-v-purple-light border border-v-purple px-4 py-3 inline-block rounded font-hk text-v-purple">On
                                Hold</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="relative mx-auto w-20 sm:mx-0 sm:mr-3 sm:pr-0">
                            <div class="aspect-w-1 aspect-h-1 w-full">
                                <img src="/assets/img/unlicensed/backpack-1.png" alt="product image"
                                    class="object-cover">
                            </div>
                        </div>
