                                        ...
                                        @forelse ($transactions as $transaction)
                                            ...
                                            <tr
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    <button id="dropdownMenuIconButton{{ $transaction->id }}"
                                                        data-dropdown-toggle="dropdownDots{{ $transaction->id }}"
                                                    ...
                                                    <!-- Dropdown menu -->
                                                    <div id="dropdownDots{{ $transaction->id }}"
                                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                            aria-labelledby="dropdownMenuIconButton{{ $transaction->id }}">
                                                            <li>
                                                                {{-- Deactivate --}}
