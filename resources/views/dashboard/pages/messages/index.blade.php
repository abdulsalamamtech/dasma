                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                ...
                                {{ Number::abbreviate($allMessages ?? 0) }}
                            </h4>
                        </div>
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                ...
                                {{ Number::abbreviate($readMessages ?? 0) }}
                            </h4>
                        </div>
            ...
            <div class="my-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="relative p-8 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div
                        ...
                        <form class="w-full max-w-md mx-auto" action="{{ route('admin.messages.index') }}" method="GET">
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @forelse ($messages as $message)
                                        ...
                                        <div id="dropdownDots{{ $message->id }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    ...
                                                    <div href="#"
                                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        <button data-modal-target="popup-modal{{ $message->id }}"
                                                            data-modal-toggle="popup-modal{{ $message->id }}"
                                ...
                                {{-- Delete Popup Modal --}}
                                <div id="popup-modal{{ $message->id }}" tabindex="-1"
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <form action="{{ route('admin.messages.destroy', $message->id) }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-modal-hide="popup-modal{{ $message->id }}">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                        Are you sure you want to delete this resource? (message Id:
                                                        {{ $message->id }})</h3>
                                                    <button data-modal-hide="popup-modal{{ $message->id }}"
                                                        type="submit"
                                                ...
                                                <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        ...
                                                        <input type="text" name="" id="last-name"
                                                            ...
                                                            value="{{ $message?->created_at->format('D. d M Y. h:i:s a') }}"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div id="accordion-collapse{{ $message->id }}"
                                                    ...
                                                    <div id="accordion-collapse-body-1{{ $message->id }}" class="hidden"
                                                        ...
                                                        <div class="p-5 border border-gray-200 dark:border-gray-700">
                                                            ...
                                                            {{-- Product Items Image --}}
                                                            <div
                                                                class="col-span-12 bg-white dark:bg-gray-500 dark:text-white p-2">
