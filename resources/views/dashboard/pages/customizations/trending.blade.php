    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="rounded-lg dark:border-gray-700 mt-20">
            ...
            <div class="mb-2 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <iframe src="{{ config('app.url') }}?#trending" frameborder="0"
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                Max 100 characters (use break tag to display the sentence on multiple
                                                lines!)
                                            </div>
                                        </div>
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                        ...
                                                        <li>
                                                            ...
                                                            <div href="#"
                                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                                <button
                                                                    data-modal-target="popup-modal{{ $customization->id }}"
                                                ...
                                                <form action="{{ route('admin.customizations.update', $customization->id) }}"
                                                    ...
                                                    <div class="p-6 space-y-6 bg-white dark:bg-gray-700">
                                                        ...
                                                        <div class="col-span-12">
                                                            ...
                                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                                Max 100 characters (use break tag to display the sentence on
                                                                multiple lines!)
                                                            </div>
                                                        </div>
                                                                ...
                                                                @isset($categories)
                                                                    @foreach ($categories as $category)
                                                                        <option value="{{ $category->id }}"
                                                                            @selected($category->id === $customization->category_id)>{{ $category->name }}
                                                                        </option>
                                                                    @endforeach
                                                                @endisset
                                                            </select>
