                ...
                <div class="grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4 mb-4">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                ...
                                {{ Number::abbreviate($data['total_count'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="border-t border-yellow-gray-50 p-4">
                            <p
                                class="block antialiased font-sans text-base leading-relaxed font-normal text-yellow-gray-600">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['new_users_this_month'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="border-t border-yellow-gray-50 p-4">
                            <p
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['total_verified_users'] ?? 0) }}
                            </h4>
                        </div>
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['total_pending_users'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-yellow-gray-50 p-4">
                            <p
                ...
                <div class="grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['total_customers'] ?? 0, 2) }}
                            </h4>
                        </div>
                        <div class="border-t border-yellow-gray-50 p-4">
                            <p
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['new_users_this_year'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="border-t border-yellow-gray-50 p-4">
                            <p
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['total_customers_without_orders'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-yellow-gray-50 p-4">
                            <p
                    ...
                    <div
                        ...
                        <div class="p-4 text-right">
                            ...
                            <h4
                                class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-yellow-gray-900">
                                {{ Number::abbreviate($data['total_customers_with_orders'] ?? 0) }}
                            </h4>
                        </div>
                        <div class="dark:border-gray-500 border-t border-yellow-gray-50 p-4">
                            <p
                        ...
                        <div>
                            ...
                            <div id="dropdownAction"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="?search=admin"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Admins</a>
                                    </li>
                                    <li>
                                        <a href="?search=customer"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Customers</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <form class="w-full max-w-md mx-auto" action="{{ route('admin.users.index') }}" method="GET">
                            ...
                            <div class="relative">
                                ...
                                <input type="search" name="search" id="default-search"
                                    class="@error('search') {{ 'border-red-500' }} @enderror block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
                                            ...
                                            <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                        Are you sure you want to delete this resource? (User Id:
                                                        {{ $user->id }})</h3>
                                                ...
                                                <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        ...
                                                        <input type="text" name="last_name" id="last-name"
                                                            ...
                                                            value="{{ $user?->created_at->format('D. d M Y. h:i:s a') }}"
                                                            disabled>
                                                    </div>
                                                    <div class="col-span-6 sm:col-span-3">
                                                        <label for="email"
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        ...
                                                        <input type="tel" name="phone" id="phone"
                                                            ...
                                                            value="{{ $user->addresses->first()?->phone_number }}"
                                                            disabled>
                                                    </div>
                                                    <div class="col-span-6 sm:col-span-3">
                                                        <label for="verified"
