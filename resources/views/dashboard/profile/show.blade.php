                ...
                <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="mt-3">Registered on: <span class="text-gray-500">{{ Auth::user()?->created_at->format('D. d M Y. h:i:s a') ?? '' }}</span></div>
                            <div class="mt-3">Account Created: <span class="text-gray-500">{{ Auth::user()?->created_at->diffForHumans() ?? '' }}</span></div>
