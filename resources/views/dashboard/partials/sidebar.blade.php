    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium mt-2">
                ...
                <li>
                    <form method="post" action="{{ route('logout') }}" class="hover:bg-red-700 dark:hover:bg-gray-700 text-gray-900 hover:text-gray-100 rounded-lg dark:text-white w-full">
                        @csrf
                        <button type="submit"
