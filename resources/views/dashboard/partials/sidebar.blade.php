        ...
        <ul class="space-y-2 font-medium mt-2">
            ...
            <li>
                <form method="post" action="{{ route('logout') }}"
                    class="hover:bg-red-700 dark:hover:bg-gray-700 text-red-200 bg-red-500 hover:text-red-100 rounded-lg dark:text-white w-full">
                    @csrf
                    <button type="submit" class="w-100 py-2 flex items-center rounded-lg group">
                        <div
                            class="flex-shrink-0 w-8 h-5 text-red-200 dark:text-gray-400 group-hover:text-red-200 dark:group-hover:text-white">
