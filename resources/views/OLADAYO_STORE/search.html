...
<html lang="en">
  ...
  <title>Search | Elyssi Template</title>
	<link rel="canonical" href="https://elyssi.redpixelthemes.com/search.html" />
  <meta property="og:title" content="Search | Elyssi Template"/>
  <meta property="og:locale" content="en_US"/>
  <meta name="theme-color" content="#f35627"/>
  <meta
    property="og:url"
    content="https://elyssi.redpixelthemes.com/search"/>
  <meta
    name="description"
  ...
  <link
    rel="stylesheet"
    href="npm/boxicons-2.0.5/css/boxicons.min.css"
    />
  <link
    rel="stylesheet"
  ...
  <link
    rel="stylesheet"
    href="npm/-splidejs/splide-3.6.12/dist/css/splide.min.css"/>
  ...
  <body
    ...
    <div
      ...
      style="background-color: #24c790">
      <img
        src="assets/img/logo-r.svg"
        alt="red pixel themes logo"
        class="mr-4 h-7 w-auto md:h-10"/>
  ...
  <div class="relative z-50 py-6 shadow-xs lg:py-10">
    <div class="flex items-center justify-between">
      ...
      <a href="index.html">
        <img
          src="assets/img/logo-elyssi.svg"
          class="h-auto w-28 sm:w-48"
          alt="logo"/>
      </a>
      <div class="flex items-center">
        <a
              ...
              <div class="relative z-20 flex-1">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Blutcher Boot</a>
                  </li>
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Chelsea Boot</a>
                  </li>
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Chukka Boot</a>
                  </li>
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Dress Boot</a>
                  </li>
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Work Boot</a>
                  </li>
                </ul>
              </div>
              <div class="relative z-20 flex-1">
              ...
              <div class="relative z-20 flex-1">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="collection-grid.html"
                      class="border-b border-transparent font-hk text-sm leading-loose text-secondary-lighter hover:border-secondary-lighter">Derby Shoes</a>
                  </li>
                  <li>
                    <a
                      href="collection-grid.html"
...
<div
  ...
  <div
    ...
    <a class='block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary' href='account/wishlist.html'>Wishlist
    </a>
    <div
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <a :class='isAccordionOpen ? \'text-primary\' : \'text-grey-darkest\'' class='font-hk font-medium transition-colors' href='collection-grid.html'>Men's Fashion</a>
          </div>
          <div
            ...
            <a class='mt-2 block font-hk font-medium text-secondary' href='collection-grid.html'>Travel Essentials</a>
          </div>
        </div>
    ...
    <a class='block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary' href='about.html'>About
    </a>
    <a
      href="contact.html#faq"
      class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">FAQ
    </a>
    <a class='block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary' href='blog.html'>Blog
    </a>
    <a class='block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary' href='contact.html'>Contact
    </a>
    <div class="my-8">
      <a
        href="login.html"
      ...
      <a
        href="register.html"
        class="block pl-3 text-center font-hk text-secondary underline md:text-lg">Create your account</a>
    </div>
  </div>
</div>
<div
...
<div
  ...
  <div
    ...
    <div
      ...
      <div class="flex items-center">
        <i
          class="bx bx-x mr-2 cursor-pointer text-2xl text-grey-darkest sm:text-3xl"></i>
      ...
      <div class="flex items-center pl-3">
        <span
          class="flex h-6 w-6 items-center justify-center rounded-full border border-primary"><i class="bx bx-minus text-primary"></i></span>
        <span class="font-hkbold block px-2 text-lg text-primary">1</span>
        <span
          class="flex h-6 w-6 items-center justify-center rounded-full border border-primary"><i class="bx bx-plus text-primary"></i></span>
      </div>
    </div>
    <div
      class="flex items-center justify-between border-b border-grey-dark pb-2">
    ...
    <a
      href="cart.html"
      class="mt-4 block pl-3 text-center font-hk text-secondary underline md:text-lg">Go to cart page</a>
  </div>
</div>
      <div>
<div class="container">
  <div class="relative flex">
    <div
      class="ml-auto h-64 w-3/4 bg-cover bg-center bg-no-repeat md:h-68"
      style="background-image:url(assets/img/about-hero.png)"></div>
    <div
      class="c-hero-gradient-bg absolute top-0 left-0 h-64 w-full bg-cover bg-no-repeat md:h-68">
      <div class="py-16 px-6 text-center sm:px-12 md:py-20 lg:px-20">
        <h1
          class="font-butler text-2xl text-white sm:text-3xl md:text-4.5xl lg:text-5xl">
          Search
        </h1>
        <form class="flex justify-center pt-6 md:pt-8">
          ...
          <button
            ...
            <img
              src="assets/img/icons/icon-search-white.svg"
    ...
    <div
      ...
      <div class="group relative w-full lg:last:hidden xl:last:block">
        <div class="relative flex items-center justify-center rounded">
          <div
            class="h-68 w-full bg-cover bg-center bg-no-repeat"
  ...
  <div class="container py-16 sm:py-20 md:py-24">
    <div
      ...
      <div class="text-center lg:text-left">
        ...
        <ul class="list-reset">
          ...
          <li class="block pb-2">
            <a
              href="tel:0123234222"
              class="font-hk text-base tracking-wide text-white transition-colors hover:text-primary">0123 234 222</a>
          </li>
          <li class="block pb-2">
            <a
      ...
      <div class="py-16 text-center lg:py-0">
        <a
          href="index.html"
          class="font-butler text-4xl uppercase tracking-wider text-white">Elyssi.</a>
      ...
      <div class="text-center lg:text-left">
        ...
        <ul class="list-reset">
          ...
          <li class="block pb-2">
            <a
              href="single.html"
              class="font-hk text-base tracking-wide text-white transition-colors hover:text-primary">Terms & Conditions</a>
          </li>
        </ul>
      </div>
    </div>
